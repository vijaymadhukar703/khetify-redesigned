...
export const SELLER_MODULES = [
  ...
  { key: "pos", label: "POS", icon: "point_of_sale", phase: 5, desc: "Counter billing — sell and deduct stock instantly.", path: "/seller/pos", live: true, feature: "pos_billing", cap: "order:create", noApproval: true },
