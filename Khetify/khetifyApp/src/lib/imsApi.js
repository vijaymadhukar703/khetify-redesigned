...
export const getPendingReceiptLots = () => data(api.get("lots/pending-receipt"));
...
export const getInventory = (params = {}) =>
  data(api.get("inventory", { params }));
export const getMovements = (productId) =>
  data(api.get(`inventory/${productId}/movements`));
...
export const changeMyPassword = (body) =>
  data(api.post("users/change-password", body));
export const requestMemberPasswordReset = (body) =>
  data(api.post("users/forgot-password", body));
...
export const saveCompanyPcForm = (fields) =>
  data(api.put("company/pc-form", { fields }));
export const getCompanyPcApplications = (status) =>
  data(
    api.get("company/pc-applications", { params: status ? { status } : {} }),
  );
export const getCompanyPcApplication = (id) =>
  data(api.get(`company/pc-applications/${id}`));
export const reviewPcApplication = (id) =>
  data(api.post(`company/pc-applications/${id}/review`));
export const requestPcDocs = (id, body) =>
  data(api.post(`company/pc-applications/${id}/request-docs`, body));
export const rejectPcApplication = (id, reason) =>
  data(api.post(`company/pc-applications/${id}/reject`, { reason }));
export const approvePcApplication = (id) =>
  data(api.post(`company/pc-applications/${id}/approve`));
export const attachPcAgreement = (id, formData) =>
  data(api.post(`company/pc-applications/${id}/agreement/attach`, formData));
export const issuePc = (id, body) =>
  data(api.post(`company/pc-applications/${id}/issue-pc`, body));
export const getCompanyCertificates = (status) =>
  data(api.get("company/certificates", { params: status ? { status } : {} }));
export const revokeCertificate = (id, reason) =>
  data(api.post(`company/certificates/${id}/revoke`, { reason }));
export const reinstateCertificate = (id) =>
  data(api.post(`company/certificates/${id}/reinstate`));
export const verifySellerDocument = (id, note) =>
  data(api.post(`company/seller-documents/${id}/verify`, { note }));
export const rejectSellerDocument = (id, note) =>
  data(api.post(`company/seller-documents/${id}/reject`, { note }));
...
export const getSupplyOrders = (params = {}) =>
  data(api.get("supply-order", { params }));
export const getSupplyPendingCount = () =>
  data(api.get("supply-order/pending-count"));
// Per-warehouse availability for the order's items (drives "Assign a source warehouse").
export const getSupplySourceOptions = (id) =>
  data(api.get(`supply-order/${id}/source-options`));
...
export const getSupplyOrderDetails = (id) =>
  data(api.get(`supply-order/${id}/details`));
export const updateSupplyStatus = (id, body) =>
  data(api.put(`supply-order/${id}/status`, body));
// Direct pick/pack/dispatch on the supply order (no PickList/wave).
export const pickSupplyOrder = (id, body) =>
  data(api.post(`supply-order/${id}/pick`, body));
export const packSupplyOrder = (id, body = {}) =>
  data(api.post(`supply-order/${id}/pack`, body));
// Ensure a planned shipment + manifest token for the label barcode (idempotent).
export const getSupplyManifest = (id) =>
  data(api.get(`supply-order/${id}/manifest`));
export const dispatchSupplyOrder = (id, body) =>
  data(api.post(`supply-order/${id}/dispatch`, body));
...
export const getWarehouseDirectory = () =>
  data(api.get("warehouse", { params: { directory: 1 } }));
export const createWarehouse = (body) => data(api.post("warehouse", body));
export const updateWarehouse = (id, body) =>
  data(api.put(`warehouse/${id}`, body));

/* ---- storage locations / bins (NEW backend: /api/locations) ---- */
export const getLocations = (params = {}) =>
  data(api.get("locations", { params }));
export const getLocationBins = (params = {}) =>
  data(api.get("locations/bins", { params }));
export const createLocation = (body) => data(api.post("locations", body));
export const generateLocations = (body) =>
  data(api.post("locations/generate", body));
...
export const getTmsShipments = (params = {}) =>
  data(api.get("shipments", { params }));
// Shipment Box labels for one consignment — printed from Shipment Tracking.
export const getShipmentBoxes = (shipmentId) =>
  data(api.get(`shipments/${shipmentId}/boxes`));
...
export const getRepackBox = (id) =>
  data(api.get(`repack-boxes/${encodeURIComponent(id)}`));
...
export const listRepackBoxes = (shipmentId) =>
  data(api.get("repack-boxes", { params: { shipmentId } }));
...
/* ---- receiving a transfer BY SCANNING ITS CARTONS ----
   ...
   the rest. */
export const getReceiveChecklist = (id) =>
  data(api.get(`shipments/${id}/receive-checklist`));
export const receiveScan = (id, body) =>
  data(api.post(`shipments/${id}/receive-scan`, body));
export const receiveUnits = (id, body) =>
  data(api.post(`shipments/${id}/receive-units`, body));
export const unpackRepackBox = (id) =>
  data(api.post(`repack-boxes/${encodeURIComponent(id)}/unpack`));
...
export const discardRepackBox = (id) =>
  data(api.delete(`repack-boxes/${encodeURIComponent(id)}`));
...
export const getSellerTransferOptions = () =>
  data(api.get("supply-order/transfer/options"));
...
export const scanSellerTransferItem = (body) =>
  data(api.post("supply-order/transfer/scan", body));
...
export const confirmSellerTransfer = (body) =>
  data(api.post("supply-order/transfer", body));
...
export const getSellerTransferHistory = (params = {}) =>
  data(api.get("supply-order/transfer/history", { params }));

/* ---- inter-warehouse stock requests (B asks A; A accepts/rejects) ---- */
export const getTransferRequests = (params = {}) =>
  data(api.get("transfer-requests", { params }));
export const createTransferRequest = (body) =>
  data(api.post("transfer-requests", body));
export const acceptTransferRequest = (id, body = {}) =>
  data(api.post(`transfer-requests/${id}/accept`, body));
export const rejectTransferRequest = (id, body = {}) =>
  data(api.post(`transfer-requests/${id}/reject`, body));

export const approveShipment = (id) =>
  data(api.post(`shipments/${id}/approve`));
...
export const dispatchShipment = (id, body = {}) =>
  data(api.post(`shipments/${id}/dispatch`, body));
...
export const getDispatchChecklist = (id) =>
  data(api.get(`shipments/${id}/dispatch-checklist`));
export const dispatchScan = (id, body) =>
  data(api.post(`shipments/${id}/dispatch-scan`, body));
export const verifyShipment = (id, body) =>
  data(api.post(`shipments/${id}/verify`, body));
...
export const getIncomingTransferByLot = (lot) =>
  data(api.get("shipments/incoming", { params: { lot } }));
...
export const getIncomingLot = (lot) =>
  data(api.get("lots/incoming", { params: { lot } }));
...
export const confirmLotReceipt = (id) =>
  data(api.post(`lots/${id}/confirm-receipt`));
...
export const getLotAvailableUnits = (lotId) =>
  data(api.get(`lots/${lotId}/available-units`));
...
export const getLotTransferSnapshot = (lotId) =>
  data(api.get(`lots/${lotId}/transfer-snapshot`));
...
export const getBulkPackages = (lotId) =>
  data(api.get(`lots/${lotId}/bulk-packages`));
// Resolve ONE scanned Bulk Packaging ID. Read-only; moves nothing.
export const getIncomingBox = (code) =>
  data(api.get("lots/incoming-box", { params: { code } }));
...
export const deliverShipment = (id, body) =>
  data(api.post(`shipments/${id}/deliver`, body));
export const shipmentException = (id, body) =>
  data(api.post(`shipments/${id}/exception`, body));
export const getDiscrepancies = (params = {}) =>
  data(api.get("shipments/discrepancies", { params }));
...
export const driverArrived = (id, body) =>
  data(api.post(`driver/shipments/${id}/arrived`, body));
export const driverPod = (id, body) =>
  data(api.post(`driver/shipments/${id}/pod`, body));
export const driverException = (id, body) =>
  data(api.post(`driver/shipments/${id}/exception`, body));
...
export const generateWave = (body) =>
  data(api.post("picklists/generate", body));
export const getPickLists = (params = {}) =>
  data(api.get("picklists", { params }));
export const getPickList = (id) => data(api.get(`picklists/${id}`));
export const pickLine = (id, body) =>
  data(api.post(`picklists/${id}/pick`, body));
// Direct order pick (no wave): { picks: [{ productId, serials?, qty?, binCode? }] }
export const pickOrder = (id, body) =>
  data(api.post(`picklists/order/${id}/pick`, body));
...
export const getOrderSummary = (params = {}) =>
  data(api.get("orders/summary", { params }));
export const getOrderHistory = (params = {}) =>
  data(api.get("orders/history", { params }));
...
export const getShipmentDetails = (id) =>
  data(api.get(`shipments/${id}/details`));
...
export const getDashboardSummary = (params = {}) =>
  data(api.get("reports/dashboard", { params }));
export const runReport = (name, params = {}) =>
  data(api.get(`reports/${name}`, { params }));
export const downloadReportCsv = async (name, params = {}) => {
  const res = await api.get(`reports/${name}`, {
...
export const updateCompanyProfile = (formData) =>
  data(api.patch("company/profile", formData));

/* ---- 📱 Phone verification (company profile) ----
   Number body में नहीं जाता — server उसे token वाले account से ही लेता है,
   इसलिए कोई किसी और का number "verified" नहीं करवा सकता.
   verify सफल होने पर पूरा profile लौटाता है (GET /profile वाला ही shape),
   इसलिए badge बदलने के लिए दूसरी request नहीं करनी पड़ती. */
...
export const sendCompanyPhoneOtp = (number) =>
  data(api.post("company/profile/phone/send-otp", number ? { number } : {}));
export const verifyCompanyPhoneOtp = (code) =>
  data(api.post("company/profile/phone/verify", { code }));
export const updateCompany = (id, body) =>
  data(api.put(`company/update/${id}`, body));
...
export const receiveGRN = (id, body) =>
  data(api.patch(`grn/${id}/receive`, body));
export const postGRN = (id) => data(api.post(`grn/${id}/post`));
export const writeoffDamaged = (body) => data(api.post("grn/writeoff", body));
export const getPutawayTasks = (params = {}) =>
  data(api.get("putaway", { params }));
export const completePutaway = (id, body) =>
  data(api.post(`putaway/${id}/complete`, body));

/* ---- adjustments (NEW backend: /api/adjustments) ---- */
export const getAdjustments = (params = {}) =>
  data(api.get("adjustments", { params }));
export const createAdjustment = (body) => data(api.post("adjustments", body));
export const approveAdjustment = (id) =>
  data(api.post(`adjustments/${id}/approve`));
export const rejectAdjustment = (id) =>
  data(api.post(`adjustments/${id}/reject`));

/* ---- cycle counts / audits (NEW backend: /api/cycle-counts) ---- */
export const getCycleCounts = (params = {}) =>
  data(api.get("cycle-counts", { params }));
export const getCycleCount = (id) => data(api.get(`cycle-counts/${id}`));
export const generateCount = (body) =>
  data(api.post("cycle-counts/generate", body));
export const submitCount = (id, body) =>
  data(api.patch(`cycle-counts/${id}/submit`, body));
export const completeCount = (id) =>
  data(api.post(`cycle-counts/${id}/complete`));
...
export const markUnitsPrinted = (serials) =>
  data(api.post("units/print", { serials }));
export const getUnitHistory = (serial) =>
  data(api.get(`units/history/${serial}`));
...
export const createWebhook = (body) =>
  data(api.post("integrations/webhooks", body));
export const updateWebhook = (id, body) =>
  data(api.patch(`integrations/webhooks/${id}`, body));
export const deleteWebhook = (id) =>
  data(api.delete(`integrations/webhooks/${id}`));
export const testWebhook = (id) =>
  data(api.post(`integrations/webhooks/${id}/test`));
export const getChannels = () => data(api.get("integrations/channels"));
export const connectChannel = (body) =>
  data(api.post("integrations/channels", body));

/* ---- enterprise: owner KPIs, costing, reconciliation (NEW backend) ---- */
export const getOwnerDashboard = (params = {}) =>
  data(api.get("owner/dashboard", { params }));
export const getProductCosts = () => data(api.get("costing"));
export const requestCostChange = (productId, body) =>
  data(api.post(`costing/${productId}/request`, body));
export const approveCostChange = (productId, approve) =>
  data(api.post(`costing/${productId}/approve`, { approve }));
export const getProfitability = (params = {}) =>
  data(api.get("costing/profitability", { params }));
export const upsertShipmentCost = (shipmentId, body) =>
  data(api.put(`transport-costs/${shipmentId}`, body));
export const getTransportCostSummary = (params = {}) =>
  data(api.get("transport-costs/analytics/summary", { params }));
...
export const createVendor = (body) =>
  data(api.post("purchasing/vendors", body));
export const getPurchaseOrders = () =>
  data(api.get("purchasing/purchase-orders"));
export const createPurchaseOrder = (body) =>
  data(api.post("purchasing/purchase-orders", body));
...
export const markNotificationRead = (id) =>
  data(api.put(`notifications/${id}/read`));
export const markAllNotificationsRead = () =>
  data(api.put("notifications/read-all"));
...
export const expiryBadge = (d) => {
  ...
  if (days === null)
    return { label: "No expiry", cls: "bg-stone-100 text-stone-500" };
  if (days < 0) return { label: "Expired", cls: "bg-red-50 text-red-600" };
  if (days <= 90)
    return { label: `${days}d left`, cls: "bg-orange-50 text-orange-600" };
